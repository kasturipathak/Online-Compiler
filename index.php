...
<div class="main">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top nbar">
    <div class="navbar-header">
      <img class="navbar-brand" margin-left="100px" src="logo.png" alt="Online Compiler" style="width:100px;height:73px;">
...
<option value="java">Python27</option>
<option value="java">Python3</option>
